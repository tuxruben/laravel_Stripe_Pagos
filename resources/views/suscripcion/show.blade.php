...
<p class="text-black-50">{{$item->product}}</p>
...
<script>
(function() {
  var stripe = Stripe('pk_test_51JNrhOA7H21qhYd1VbbGy7GGP3qbP3NyYrgLwGj2y0ce6gbRkdKP3uwMsdSafGa16hmc6KudQcCmMlM7wpt1XyXF00UJaHHO6e');

  var checkoutButton = document.getElementById('checkout-button-price_1JOYuVA7H21qhYd1tYNUO7Xd');
 $(".pay").click(function(e){
    stripe.redirectToCheckout({
      lineItems: [{price: $(this).data('sku'), quantity: 1}],
      mode: 'subscription',
      /*
