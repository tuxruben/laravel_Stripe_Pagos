...
<script>
    const stripe = Stripe('pk_test_51JNrhOA7H21qhYd1VbbGy7GGP3qbP3NyYrgLwGj2y0ce6gbRkdKP3uwMsdSafGa16hmc6KudQcCmMlM7wpt1XyXF00UJaHHO6e');
...
cardButton.addEventListener('click', async (e) => {
    ...
    if (error) {
        ...
        $.post({
        url: 'http://localhost:8080/stripe/public/card-save',
        data:{
